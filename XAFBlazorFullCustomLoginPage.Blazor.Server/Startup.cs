...
using XAFBlazorFullCustomLoginPage.WebApi.JWT;
...
namespace XAFBlazorFullCustomLoginPage.Blazor.Server {
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services) {
            ...
            services.AddXaf<XAFBlazorFullCustomLoginPageBlazorApplication>(Configuration);
            ...
            services.AddXafSecurity(options => {
                ...
                options.UserType = typeof(XAFBlazorFullCustomLoginPage.Module.BusinessObjects.ApplicationUser);
                // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                options.UserLoginInfoType = typeof(XAFBlazorFullCustomLoginPage.Module.BusinessObjects.ApplicationUserLoginInfo);
            ...
            services.AddSwaggerGen(c => {
                ...
                c.SwaggerDoc("v1", new OpenApiInfo {
                    Title = "XAFBlazorFullCustomLoginPage API",
                    Version = "v1",
                    Description = @"Use AddXafWebApi(options) in the XAFBlazorFullCustomLoginPage.Blazor.Server\Startup.cs file to make Business Objects available in the Web API."
                });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
            if(env.IsDevelopment()) {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "XAFBlazorFullCustomLoginPage WebApi v1");
                });
            }
            else {
